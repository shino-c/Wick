  ...
  return (
    <>
      ...
      {/* The notification modal and its state belong to the shared top bar, so
          ...
          Hoisted outside the header container so the modal's absolute
          positioning fills the full-screen parent (Screen / app layer) instead
          of the header bar's small box — otherwise the overlay is clipped to
          the top bar height and the dialog never fills the phone glass on
          web. */}
      {(
        <AppModal
        ...
        >
          <View style={styles.notificationCard}>
            ...
            {hasUnread && (
              <Pressable style={styles.notificationDone} onPress={markAllRead}>
...
const styles = StyleSheet.create({
  ...
  notificationCard: { backgroundColor: colors.surface, borderRadius: 24, padding: 20, width: '100%' },
  ...
  confirmCard: { backgroundColor: colors.surface, borderRadius: 24, padding: 24, width: '100%', alignItems: 'center' },
